# Splits the complete dataset into training set and test set returning the 
# following objects:
# -Training X
# -Training Y
# -Training Characters
...
split_training_test <- function(dataset, characters, rows_for_character) {
  ...
  # Instances Splitting
  train_dataset_size <- train_chars_size * rows_for_character
